...
| 1 | 0:30 | **Phone (new donor)** | `/start` → **🍱 I have food to share**. Type a name, pick *Business*, set the location, then **✅ I pledge**. | The intro (live totals, "How it works" in 3 steps), then a 30-second sign-up in the chat | "A carinderia owner opens Telegram. No app to install: the bot explains itself, and there's a safety pledge up front." |
